...
module.exports.createGame = function(req,res){
    ...
    // db.query("select coins from user where id = ?",[user_id1],function(err,result){
    //     if(err){
    //         console.log("Error in inserting into the database");
    //     }
    //     coins1 = result[0].coins;
    //     db.query("select coins from user where id = ?",[user_id2],function(err,result){
    //         if(err){
    //             console.log("Error in inserting into the database");
    //         }
    //         coins2 = result[0].coins;
    //         db.query("select coins from user where id = ?",[user_id3],function(err,result){
    //             if(err){
    //                 console.log("Error in inserting into the database");
    //             }
    //             coins3 = result[0].coins;

    //             // console.log(coins1 + " " + coins2 + " " + coins3);
...
// module.exports.hitButton = function(req,res){
...
//     var split = false;
//     console.log(getCardNumericValue(dealerCards[0]));
//     console.log(getCardNumericValue(dealerCards[1]));

//     if(getCardNumericValue(dealerCards[0]) == getCardNumericValue(dealerCards[1])){
//         console.log(getCardNumericValue(dealerCards[0]) + " " + getCardNumericValue(dealerCards[1]));
//         split = true;
//     }
